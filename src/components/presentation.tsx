...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hi👋!\nI'm Hatta. A Computer Science graduate specializing in AI and Machine Learning. I build practical, full-stack applications that solve real-world problems. My experience includes engineering AI chatbots with RAG systems and developing a sophisticated biomedical chatbot for my thesis using LLMs, LangChain, and graph databases. I thrive on turning emerging tech into efficient, impactful solutions.",
    src: '/msc.jpg',
    fallbackSrc:
